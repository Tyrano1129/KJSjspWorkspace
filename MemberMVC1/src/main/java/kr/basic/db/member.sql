...
insert into member(id,pass,name,age,email,phone) values('test8','8888','테스트8',38,'test8@test.com','010-1111-1210');

select * from member where num=1;
delete from member where num=10;
update member set age=33,email=123123,phone=12312312 where num=2;
